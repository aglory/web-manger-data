								...
								<div class="panel-title clearfix">
									<div class="col-sm-12 clearfix">
										<div class="btn-group f_l">
											...
											<button class="btn btn-sm btn-default" type="button" onclick="categoryImageChangeStatus(this,0,1)">启用</button>
											<button class="btn btn-sm btn-default" type="button" onclick="categoryImageChangeStatus(this,0,0)">禁用</button>
