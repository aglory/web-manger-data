<?php
	...
	if(empty($Id)){
		$sth = $pdomysql -> prepare('insert into tbCategoryImageInfo(Title,Tag,Img,Scrawled,Src,Level,DateTimeCreate,DateTimeModify,Status)values(:Title,:Tag,:Img,:Scrawled,:Src,:Level,:DateTimeCreate,:DateTimeModify,:Status);');
	...
	$sth = $pdomysql -> prepare('update tbCategoryImageInfo set Title=:Title,Tag=:Tag,Img=:Img,Src=:Src,Scrawled=:Scrawled,Level=:Level,DateTimeModify=:DateTimeModify where Id = :Id;');
	$sth -> execute(array(
		'Id' => $Id,
		'Title' => $Title,
		'Tag' => $Tag,
